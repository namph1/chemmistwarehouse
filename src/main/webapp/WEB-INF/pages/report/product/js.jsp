...
<script type="text/javascript">
    ...
    function onSearch(currPage) {
        ...
        $.ajax({
            ...
            url: "<%=request.getContextPath()%>/report/sanpham"
        }).done(function (data) {
            $("#divTable").html(data);
    ...
    function onExport() {
        ...
        location.href = "<%=request.getContextPath()%>/report/exportProduct?code=" + code + "&from=" + from + "&to=" + to;
//        var search = {};
//        search["from"] = $('#fromDate').val().trim();
//        search["to"] = $('#toDate').val().trim();
//        search["customerCode"] = $('#code').val().trim();
...
////            data: JSON.stringify(search),
//            url: "<%=request.getContextPath()%>/report/exportProduct?name=1"
//        }).done(function (data) {
//            alert(data);
//        });
    }
