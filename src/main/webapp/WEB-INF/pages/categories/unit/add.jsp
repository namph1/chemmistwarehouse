<%-- 
    Document   : add
    Created on : Nov 1, 2017, 10:22:36 PM
    Author     : Admin
--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row" >
                    <label for="name" class="col-md-3 control-label required" >Tên đơn vị</label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" id="add-name"
                               name="name" maxlength="30" required="required">
                    </div>
                </div>
                <div class="form-group row" >
